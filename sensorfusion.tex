...
\usepackage[backref,bookmarks=true,pdfpagelabels,plainpages=false,hidelinks]{hyperref}
...
\subject{Fortgeschrittene ARM-Mikrocontroller-Programmierung}
\title{Orientierungserkennung durch MARG-Sensorfusion mittels eines indirekten Kalman-Filters auf dem Freescale Kinetis KL25Z}
\author{Markus Mayer
				\and
				Julian Dombrow}
...
\input{./content/saleae_logic.tex}
