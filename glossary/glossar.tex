...
\newglossaryentry{Quaternion}{name = {Quaternion}, description={Hamilton-Zahl $\mathbb{H}$ im 4-dimensionalen komplexen Raum, die zur singularitätsfreien Beschreibung von Orientierungen verwendet werden kann}}
...
\newglossaryentry{Processor Expert}{name = {Processor Expert}, description={Treibergenerator von Freescale, welcher in die CodeWarrior-IDE integriert ist}}
