...
\newglossaryentry{Azimut}{name = {Azimut}, description={Horizontale Auslenkung (entsprechend des Gierwinkels)}}
\newglossaryentry{Elevation}{name = {Elevation}, description={Vertikale Auslenkung (entsprechend des Neigungswinkels)}}
...
\newglossaryentry{Gimbal Lock}{name = {Gim\-bal Lock}, description={Kardanische Blockade eines Systemes bei der Verwendung von Euler'schen Winkeln, die bei ungünstiger Kombination von Rotationen zum Verlust eines Freiheitsgrades führt}}

\newglossaryentry{Kalman-Filter}{name = {Kal\-man-\-Fil\-ter}, description={Rekursives, lineares Filter zur Schätzung stochastischer Systemparameter, dessen Entwicklung auf Rudolf Emil Kálmán zurückgeht}}
...
\newglossaryentry{conditional execution}{name = {conditional execution}, description={Bedingte Ausführung von Anweisungen, was die Notwendigkeit des Branchings umgeht}}

\newglossaryentry{Quaternion}{name = {Qua\-ter\-nion}, description={Hamilton-Zahl $\mathbb{H}$ im 4-dimensionalen komplexen Raum, die zur singularitätsfreien Beschreibung von Orientierungen verwendet werden kann}}
...
\newglossaryentry{bit banding}{name = {Bit-Ban\-ding}, description={Mapping von Speicheradresse auf einzelne Bits einer anderen Adresse}}

\newglossaryentry{tilt compensation}{name = {Tilt Com\-pen\-sa\-tion}, description={Korrektur der dreidimensionalen Neigung des Magnetometer-Messvektors mittels zusätzlicher Ausrichtungsdaten zur Bestimmung der magnetischen Nordrichtung in der zweidimensionalen Ebene}}

\newglossaryentry{Processor Expert}{name = {Pro\-cessor Ex\-pert}, description={Treibergenerator von Freescale, welcher in die CodeWarrior-IDE integriert ist}}
\newglossaryentry{bare metal}{name = {bare metal}, description={"`Blankes Metall"': Betrieb eines Mikrocontrollers ohne Betriebssystem und Frameworks}}

\newglossaryentry{Komplementaerfilter}{name = {Kom\-ple\-men\-tär\-fil\-ter}, description={Wichtungsfilter zwischen Beschleunigungs- und Drehratensensor zur Korrektur der spezifischen Drift- und Rauschmerkmale}}
...
\newglossaryentry{pooled variance}{name = {Pooled Variance}, description={sinng. Verbundvarianz, Ermitteln der Gesamtvarianz mehrerer Stichprobensätze aus derselben Grundgesamtheit oder mehrerer Grundgesamtheiten mit identischer Verteilung}}

\newglossaryentry{romable}{name = {ROMable}, description={"`im ROM speicherbar"', Bezeichnung für konstante Daten, die Kandidaten für eine Positionierung im Festwertspeicher sind}}
...
\newacronym[
	\glsshortpluralkey={LSBs},
	\glslongpluralkey={Least Significant Bits}
...
\newacronym{fll}{FLL}{Frequency-Locked Loop}
\newacronym{mcg}{MCG}{Multi-Purpose Clock Generator}
\newacronym{fei}{FEI}{FLL Engaged Internal}
\newacronym{pee}{PEE}{PLL Engaged External}

\newacronym{wfi}{WFI}{Wait For Interrupt}
\newacronym{wev}{WFE}{Wait For Event}
\newacronym{sev}{SEV}{Send Event}
