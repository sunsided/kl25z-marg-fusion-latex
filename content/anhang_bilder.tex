...
\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.5\textwidth}
			\centering
			\includegraphics[width=\textwidth]{./images/cypress_magfield.jpg}
			\caption{Populistische Darstellung \\ Quelle: \cite{an_cypress_tilt}}
		\end{subfigure}
		...
		\end{subfigure}%
		\caption[Darstellungen des Erdmagnetfeldes]{Darstellungen des Erdmagnetfeldes.\\Oben und Mitte: Die Feldlinien treffen sich an den Polen.\\Unten: Die Feldlinien durchdringen den Erdmantel.}
