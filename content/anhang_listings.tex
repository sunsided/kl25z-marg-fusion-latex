...
\begin{lstlisting}[style=lolc,caption={Fusion: Ermittlung des Quaternions aus den fusionierten Daten mittels libfixmatrix/libfixmath},label=lst:quaternion_from_kalman]
HOT NONNULL LEAF
...
Das Zustandsdiagramm zum folgenden Listing~\ref{lst:kl25z-pll-init} findet sich in Abbildung~\ref{fig:kl25z-mcg-states} auf Seite~\pageref{fig:kl25z-mcg-states}.
...
Zur entsprechenden C\#-Implementierung des Protokoll-Decoders siehe Listing~\ref{lst:csharp-p2ppdecoder} auf Seite~\pageref{lst:csharp-p2ppdecoder}.
...
Zur entsprechenden MATLAB-Implementierung des Protokoll-Decoders siehe Listing~\ref{lst:matlab-p2ppdecoder} auf Seite~\pageref{lst:matlab-p2ppdecoder}.
