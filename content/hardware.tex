...
Freescale bietet ebenfalls ein etwas teureres Board, das seit 2013 verfügbare FRDM-KL26Z (\citealp{fs_howlong}) mit dem KL26Z (MKL26Z128VLH4) an, 
welches zusätzlich zu einem Accelerometer einen Gyrosensor (in Form der FXOS87000CQ-\gls{imu}), sowie einen zusätzlichen Lichtsensor bietet. 
Es ist jedoch zu beachten, dass hierbei 17 \glspl{gpio} auf dem Evaluationsboard entfallen (vgl. Abbildung~\ref{fig:kl26z}).
...
Der \gls{OpenSDA}-Chip auf dem Entwicklungsboard kommuniziert mit der im \gls{Cortex}-Kern integrierten \gls{CoreSight}-Einheit über das \gls{JTAG}-Protokoll.
...
\subsubsection{OpenSDA unter Windows 8.1}
