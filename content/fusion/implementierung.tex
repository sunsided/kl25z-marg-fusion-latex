...
Auf die Implementierungsdetails der Testanwendung (OpenGL-Koordinaten\-trans\-formation, etc.) soll jedoch nicht weiter eingegangen werden, da es bei dieser nur um einen Nebenschauplatz der Entwicklung handelte.
