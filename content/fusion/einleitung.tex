...
ein Nickwinkel (Pitch, Elevation) von $\theta = \pm 90^\circ$ zu einer Singularität auf den Achsen \glslink{symb:phi}{$\phi$} (Yaw, Azimuth) und \glslink{symb:psi}{$\psi$} (Roll) führte.
