\chapter{Board und Hostinterface}

\todo{Foto vom Board}
\todo{Foto vom Board mit Logic Analyzer}
\todo{Screenshot vom Logan}
\todo{Detail vom Logan}
...
\todo{In Grafik oben "`timer"', da HMC5883L-Breakout keine Interrupt-Leitung besitzt.}
