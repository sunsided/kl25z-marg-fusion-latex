...
Das \gls{frdm-kl25z} ist ein Evaluationsboard für die \gls{kl25z}-Serie \glspl{mcu} von Freescale, welche auf dem ARM \gls{cortex-m0+}-Core basiert.
Das Board besitzt neben 54 \glspl{gpio}, einen USB-Controller, eine RGB-LED, einen kapazitiven Touch-Bereich, sowie einen Freescale MMA8451Q accelerometer.
Der geringen Preis des Boards von ca. 12 EUR trug letztlich zur Kaufentscheidung bei.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item 2xSPI, 2xI2C, 3xUART, 6xPWM, 6xADC, Touch Sensor, GPIO
	\end{itemize}
	\item FRDM-KL25Z Onboard peripherals
	\begin{itemize}
		\item MMA8451Q - 3-axis accelerometer
		\item PWM Controlled RGB LED
		\item Capacitive touch sensor
	\end{itemize}
	\item Evalution Form factor
	\begin{itemize}
		\item 81mm x 53mm
...
\todo{Konfiguration des ARM-Cores!}

\begin{table}
\begin{tabularx}{\textwidth}{XllX} 
\toprule
	\multicolumn{4}{l}{Konfiguration der ARM Cortex-M0+-Cores}\\  
\midrule 
	Parameter & Verilog-Name & Wert & Beschreibung \\ 
\midrule 
	...
	DAP ROM Table Base & BASEADDR & \texttt{0xF000\_2003} & Base address for DAP ROM table \\
	...
	IRQ Mask Enable & IRQDIS & \texttt{0x00000000} & Assume (for now) all 32 IRQs are used (set if IRQ is disabled) \\
...
Auf jedem Freescale Freedom-Entwicklungsboard ist weiterhin ein \gls{ocd} verbaut, welcher zusätzlich zum Debugging die 
...
\todo{Eingehen auf die BME, Stichwort Bit-Banging}
...
\begin{figure}[htbp]
    ...
    \caption[OpenSDA-Blockdiagramm]{OpenSDA-Blockdiagramm}
		Quelle: \texttt{http://mcuoneclipse.com}
