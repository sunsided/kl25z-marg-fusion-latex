...
Die Ausgabe der in MATLAB gewonnenen Kalibrierungsdaten (vgl. Abbildung~\ref{fig:sensors_unagitated}) ist in Listing~\ref{lst:sensor-calibration-data} zu finden.
