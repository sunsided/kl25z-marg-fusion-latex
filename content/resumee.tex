...
Die Autoren empfanden die Ergebnisse der Fusion als beeindruckend, da eine Reduktion des Orientierungsfehlers von mehreren Dekagrad pro Achse auf wenige Zentigrad erreicht werden konnte.
Dieser Effekt ist intuitiv assoziierbar mit starker Tiefpassfilterung, wobei die Dynamik des Systemes jedoch erhalten bleibt. Hierbei ist insbesondere zu bedenken, dass die 
...
Die Verwendung einer \gls{q16}-Fixed Point-Bibliothek führte zu einer effizienten Ausnutzung der 32bit-Architektor des Prozessors, wobei insbesondere die \gls{conditional execution}-Funktionalität
